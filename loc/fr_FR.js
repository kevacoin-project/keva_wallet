module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      tap_here_to_buy: 'Cliquez ici pour acheter du Kevacoin',
    },
    reorder: {
  ...
  send: {
    ...
    details: {
      ...
      address: 'adresse',
      amount_placeholder: 'montant à envoyer (en KVA)',
      fee_placeholder: 'plus frais de transaction (en KVA)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'votre mot de passe. Pour protéger vos biens, KevaWallet permet de créer un autre ' +
      ...
      "KevaWallet, débloquera se 'faux' espace de stockage. Le tiers pourra " +

module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      tap_here_to_buy: 'Kevacoin almak için buraya dokunun',
    },
    reorder: {
  ...
  send: {
    ...
    details: {
      ...
      address: 'adres',
      amount_placeholder: 'gönderilecek miktar (KVA cinsinden)',
      fee_placeholder: 'artı işlem ücreti (KVA cinsinden)',

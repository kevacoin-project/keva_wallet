module.exports = {
  ...
  wallets: {
    ...
    add: {
      title: 'tambah dompet',
      description:
        'Kamu bisa membuat dompet atau memindai paper wallet dalam WIF (Wallet Import Format). KevaWallet mendukung dompet Segwit.',
      scan: 'Pindai',
      create: 'Buat',
    ...
    import: {
      title: 'impor',
      explanation: 'Ketik kata mnemonic, private key, WIF, atau apapun yang kamu punya. KevaWallet akan mencoba mengimpor dompet kamu.',
      imported: 'Diimpor',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      "KevaWallet, it will unlock new 'fake' storage. This will seem " +

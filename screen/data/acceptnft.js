    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.inputKey}>
          ...
          <Button
            type='solid'
            buttonStyle={{alignSelf: 'center', marginTop: 20, borderRadius: 30, height: 40, width: 200, padding: 0, backgroundColor: KevaColors.actionText, borderColor: KevaColors.actionText}}
